...
But due to TWAMM's specificity, the status of the [Term Swap](02-term-swap.md) is updated each time the instant swap is performed, which is used to calculate the [order pool rewards](05-order-pool.md) for [LongTerm Orders](04-long-term-orders.md).

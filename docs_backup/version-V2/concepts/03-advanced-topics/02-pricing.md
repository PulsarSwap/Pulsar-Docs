...
At a high level, in Pulsar V2, _trades must be priced in the periphery_. The good news is that the [library](../../Technical%20Reference/smart-contracts/04-library.md)

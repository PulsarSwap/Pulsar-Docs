...
See [quote](../smart-contracts/05-library.md#quote).

## getAmountOut

See [getAmountOut](../smart-contracts/05-library.md#getamountout).

## getAmountIn

See [getAmountIn](../smart-contracts/05-library.md#getamountin).
...
See [getAmountsOut](../smart-contracts/05-library.md#getamountsout).
...
See [getAmountsIn](../smart-contracts/05-library.md#getamountsin).
